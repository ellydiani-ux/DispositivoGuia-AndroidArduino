...
public class BluetoothActivity extends Activity {
  ...
  //BlinguiActivity b = new BlinguiActivity();
...
//                	mainText.setText("Distância do Obstáculo: " + sbprint +"cm"); 	        // update TextView
					...
					if(sbprint.equals("1")){
						//if(x>50 && x<60 || x<10 || x>90 && x<200){
						  ...
						  //  b.repeatTTS.speak("Obstáculo Superior...:", TextToSpeech.QUEUE_FLUSH, null);
						...
						//	b.repeatTTS.speak("Obstáculo Inferior...:", TextToSpeech.QUEUE_FLUSH, null);
							buttonOsbstaculo.setVisibility(View.VISIBLE);
